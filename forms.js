    ...
    generateSampleData() {
        if (this.forms.length === 0) {
            const sampleForms = [
                {
                    id: 1,
                    title: 'Inspeção de Segurança - Edifício A',
                    description: 'Inspeção mensal dos equipamentos de segurança contra incêndio do Edifício A.',
                    status: 'completed',
                ...
                {
                    id: 2,
                    title: 'Relatório de Treinamento - Evacuação',
                    description: 'Relatório do treinamento de evacuação realizado com os funcionários do 3º andar.',
                    status: 'pending',
                ...
                {
                    id: 3,
                    title: 'Checklist de Equipamentos - Setor B',
                    description: 'Verificação dos extintores e mangueiras de incêndio do Setor B.',
                    status: 'draft',
                ...
                {
                    id: 4,
                    title: 'Análise de Risco - Laboratório',
                    description: 'Avaliação dos riscos de segurança no laboratório de química.',
                    status: 'completed',
                ...
                {
                    id: 5,
                    title: 'Manutenção Preventiva - Sistema de Alarme',
                    description: 'Relatório da manutenção preventiva do sistema de alarme de incêndio.',
                    status: 'pending',
        ...
        <div class="form-card" data-form-id="${form.id}">
            <div class="form-card-header">
                ...
                <div class="form-card-actions">
                    <button class="icon-btn edit" onclick="editForm(${form.id})" title="Editar">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button class="icon-btn delete" onclick="confirmDeleteForm(${form.id})" title="Excluir">
